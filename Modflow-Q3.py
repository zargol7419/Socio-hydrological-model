# -*- coding: utf-8 -*-
"""
Created on Fri May 12 17:17:35 2023
...
import shutil
    ...
    # use copyfile()
shutil.copyfile("E:\\zargolooo\\Thesis-04-19\\python-Thesis\\4202-Transient-calib8_MODFLOW\\Out_Mf2k\\Q-3.txt","E:\\zargolooo\\Thesis-04-19\\python-Thesis\\4202-Transient-calib8_MODFLOW\\Out_Mf2k\\4202-Transient-calib8.wel")
...
Heads = hdobj.get_data(kstpkper=None, mflay=0 , totim=2920)
print(Heads)
...
for j in idx:
    ...
    finalHead.append(Heads[96][1])
print(finalHead)
import numpy
a = numpy.asarray(finalHead)
numpy.savetxt("E:\\zargolooo\\Thesis-04-19\\python-Thesis\\Head-3.csv", a, delimiter=",")